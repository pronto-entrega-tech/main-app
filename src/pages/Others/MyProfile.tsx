...
import { ImageURISource, KeyboardAvoidingView, ScrollView, TextInput, StyleSheet } from 'react-native';
...
function Perfil({navigation}: {navigation: StackNavigationProp<any, any>}) {
  ...
  return (
    <KeyboardAvoidingView
      behavior='height'
      style={[{marginBottom: device.iPhoneNotch ? 28 : 0}, device.web? {height: device.height} : {flex: 1}]} >
      <Header navigation={navigation} title={'Meu Perfil'}/>
      <ScrollView
        showsVerticalScrollIndicator={false}
        contentContainerStyle={{backgroundColor: myColors.background, alignItems: 'center', paddingTop: 12, paddingHorizontal: 4, paddingBottom: 66}}>
        <Image
